...
namespace blackhouse.Installer.SQL
{
    ...
    internal class AssemblySqlFile
    {

        #region Fields

        private readonly static Regex FileVersionRegex = new Regex(@"ver((\.\d+){2,4})(\.[a-zA-Z\-]+)*.sql$", RegexOptions.Multiline | RegexOptions.IgnoreCase | RegexOptions.Compiled);
        ...
        public AssemblySqlFile(Assembly assembly, string fullFileName) {
